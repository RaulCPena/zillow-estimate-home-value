...
def split_my_data(df, train_pct=0.80, seed=123):
    ...
    Args:
        ...
        train_pct (float, optional): percent of train
        seed (int, optional): allows someone to duplicate data

    Returns:
        TYPE: pd.DataFrame with a train and test split where in this case %80 is in train, and %20 is in test
    """
    return train_test_split(df, train_size=train_pct, random_state=seed)
